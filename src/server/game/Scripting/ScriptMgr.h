...
public:
    ...
    virtual void OnBossCompleted(Unit* /*unit*/, Creature* /*creature*/, GameObject* /*go*/, uint32 /*bossId*/) { }
...
public:
    ...
    [[nodiscard]] virtual bool OnCompletedBoss(Creature* /*creature*/, GameObject* /*go*/, uint32 /* bossId */) { return false; }
...
public:
    ...
    virtual void OnBindToInstance(Player* /*player*/, Difficulty /*diff*/, uint32 /*mapId*/, bool /*permanent*/) { }
    ...
    [[nodiscard]] virtual bool CanAddQuest(Player* /*player*/) { return true; }
...
public: /* CreatureScript */
    ...
    bool OnCompletedBoss(Creature* creature, GameObject* go, uint32 bossId);
