...
ElunaRegister<Player> PlayerMethods[] =
{
    ...
    { "GossipClearMenu", &LuaPlayer::GossipClearMenu },
        ...
        // Custom
    { "GetPrestigeLevel", &LuaPlayer::GetPrestigeLevel },
    { "GetLastestPerksForLevelUp", &LuaPlayer::GetLastestPerksForLevelUp },
    { "GetPreviousPerks", &LuaPlayer::GetPreviousPerks },
    { "ResetLockout", &LuaPlayer::ResetLockout },
    { "GetPlayerPerks", &LuaPlayer::GetPlayerPerks },
    { "SetSelectPerk", &LuaPlayer::SetSelectPerk },
    { "GetItemEnchantSpellId", &LuaPlayer::GetItemEnchantSpellId },
    { "GetPossiblesEnchants", &LuaPlayer::GetPossiblesEnchants },
    { "ApplyRandomEnchant", &LuaPlayer::ApplyRandomEnchant },
    { "SetPrestige", &LuaPlayer::SetPrestige },
    { "StoreCreatureInCache", &LuaPlayer::StoreCreatureInCache },
    { "HasGamemode", &LuaPlayer::HasGamemode },
    { "RemoveGamemode", &LuaPlayer::RemoveGamemode },
    { "SetGamemode", &LuaPlayer::SetGamemode },
